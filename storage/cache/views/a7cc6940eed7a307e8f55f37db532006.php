...
<head>
    ...
    <style>
        ...
        .status-code { font-size: 80px; font-weight: 900; line-height: 1; color: #38bdf8; margin: 0 0 16px 0; letter-spacing: -0.05em; }
        ...
        .btn { display: inline-flex; align-items: center; justify-content: center; padding: 12px 24px; background: #2563eb; color: #ffffff; text-decoration: none; font-size: 14px; font-weight: 600; border-radius: 8px; transition: background 0.2s ease; }
...
<body>
    <div class="card">
        ...
        <p>Sorry, the page or resource you requested could not be found or has been moved.</p>
